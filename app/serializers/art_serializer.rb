class ArtSerializer < ActiveModel::Serializer
  ...
  belongs_to :user
  belongs_to :category
  attributes :id, :user_id, :artist, :artist_id, :category_id, :likes, :comments, :for_sale, :description, :caption, :link, :category, :cid, :name, :created_at, :updated_at, :tokenURI, :tokenID, :contract_address
end
